        ...
        {showcases.map((showcase) => (
          ...
          >
            <Link href={`/showcase/${showcase.id}`}>
              <div className="relative h-64 bg-zinc-950/80 backdrop-blur-xl p-6 flex flex-col justify-between overflow-hidden cursor-pointer border border-white/10 rounded-2xl group-hover:border-white/40 group-hover:shadow-[0_0_40px_rgba(255,255,255,0.15)] transition-all duration-500">
