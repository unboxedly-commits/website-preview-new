  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black font-sans">
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vw] bg-gradient-to-r from-zinc-500 to-black rounded-full blur-[120px] opacity-20 mix-blend-screen" />
      </div>
      ...
      <nav className="fixed top-0 w-full p-6 z-50 flex justify-between items-center bg-black/50 backdrop-blur-md border-b border-white/10">
        ...
        <div className="font-black tracking-widest uppercase text-xl">Creator Pro</div>
      </nav>
      ...
      <main className="relative z-10 pt-32 px-6 max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter mb-6">Creator Pro</h1>
          <p className="text-xl md:text-2xl text-white/50 max-w-2xl mx-auto font-light">The elite platform for top-tier creators.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          {[
            ...
            >
              <feature.icon size={32} className="mb-6 text-white" />
