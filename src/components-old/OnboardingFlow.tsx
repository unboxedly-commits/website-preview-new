                        ...
                        {businessInfo.reference && (/\.[a-z]{2,}/i.test(businessInfo.reference) || businessInfo.reference.startsWith('http')) ? (
                          ...
                          <>
                            <h1 className="text-4xl md:text-5xl font-black text-white leading-[1.1] mb-6 tracking-tight">
                              Structural Excellence Inspired By <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">{businessInfo.reference.replace(/^https?:\/\//, '')}</span>.
                            </h1>
                            <p className="text-white/60 text-sm leading-relaxed max-w-md mb-8">
                              We've extracted the core conversion mechanics from your reference architecture and fused them with ZevenBots automation for the {businessInfo.industry} sector.
                            </p>
                          </>
